...
export type GetPostsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', id: number, content: string, createdAt: any, username: string, likesCount: number, commentsCount: number }> };
